...
Codigo = int(input("Escriba el codigo del semestre del cual desee saber las materias, profesores y horario diurno: "))

if Codigo == 12020:
    print("\nEstudiante: Daniel Tacoa\n")
    HorarioC = [["Entrada/Salida", "LUNES", "MARTES", "MIERCOLES", "JUEVES", "VIERNES", "SABADO"], 
    ...
    print(f"Hombre, Sociedad, Ciencia y Tecnología: {HorarioC[7][4]} - Profesora Yernay Perez")
    ...
    HorarioC = [["Entrada/Salida", "LUNES", "MARTES", "MIERCOLES", "JUEVES", "VIERNES", "SABADO"], 
                ["7:00 - 7:45   ", "QUIMG", "------" ,"---------", "------", "MATTES1", "------"], 
                ["7:45 - 8:30   ", "QUIMG", "------" ,"ALJBRALEA", "------", "MATTES1", "------"], 
                ["8:30 - 9:15   ", "QUIMG", "------" ,"ALJBRALEA", "------", "MATTES1", "------"], 
                ["9:15 - 10:00  ", "-----", "------" ,"ALJBRALEA", "SEMNR2", "-------", "SEMNR2"], 
                ["10:00 - 10:45 ", "-----", "FISCS1" ,"---------", "SEMNR2", "-------", "SEMNR2"], 
                ["10:45 - 11:30 ", "-----", "FISCS1" ,"---------", "INGLS2", "-------", "------"], 
                ["11:30 - 12:15 ", "-----", "FISCS1" ,"---------", "INGLS2", "-------", "------"], 
                ["13:00 - 13:45 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["13:45 - 14:30 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["14:30 - 15:15 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["15:15 - 16:00 ", "MATT2", "------" ,"---------", "------", "-------", "------"], 
    ...
    HorarioC = [["Entrada/Salida", "LUNES", "MARTES", "MIERCOLES", "JUEVES", "VIERNES", "SABADO"], 
                ["7:00 - 7:45   ", "-----", "PROEST" ,"---------", "SSADMT", "-------", "------"], 
                ["7:45 - 8:30   ", "-----", "PROEST" ,"PROGCMACC", "SSADMT", "-------", "------"], 
                ["8:30 - 9:15   ", "-----", "PROEST" ,"PROGCMACC", "SSADMT", "-------", "------"], 
                ["9:15 - 10:00  ", "-----", "------" ,"PROGCMACC", "------", "-------", "------"], 
                ["10:00 - 10:45 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["10:45 - 11:30 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["11:30 - 12:15 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["13:00 - 13:45 ", "FISC2", "------" ,"---------", "------", "-------", "------"], 
                ["13:45 - 14:30 ", "FISC2", "------" ,"---------", "------", "-------", "------"], 
                ["14:30 - 15:15 ", "FISC2", "MATTE3" ,"---------", "------", "-------", "------"], 
                ["15:15 - 16:00 ", "-----", "MATTE3" ,"---------", "------", "-------", "------"], 
                ["16:00 - 16:45 ", "-----", "MATTE3" ,"---------", "------", "-------", "------"], 
                ["16:45 - 17:30 ", "-----", "------" ,"---------", "------", "-------", "------"]]
    ...
    HorarioC = [["Entrada/Salida", "LUNES", "MARTES", "MIERCOLES", "JUEVES", "VIERNES", "SABADO"], 
                ["7:00 - 7:45   ", "-----", "LENPR1" ,"---------", "------", "-------", "SSPRDC"], 
                ["7:45 - 8:30   ", "-----", "LENPR1" ,"PROCCDATS", "------", "-------", "SSPRDC"], 
                ["8:30 - 9:15   ", "-----", "LENPR1" ,"PROCCDATS", "------", "-------", "SSPRDC"], 
                ["9:15 - 10:00  ", "-----", "------" ,"PROCCDATS", "------", "-------", "------"], 
                ["10:00 - 10:45 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["10:45 - 11:30 ", "-----", "LOMATT" ,"---------", "LOMATT", "TEOSSMA", "------"], 
                ["11:30 - 12:15 ", "-----", "LOMATT" ,"---------", "LOMATT", "TEOSSMA", "------"], 
                ["13:00 - 13:45 ", "-----", "LOMATT" ,"---------", "LOMATT", "TEOSSMA", "------"], 
                ["13:45 - 14:30 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["14:30 - 15:15 ", "CANUM", "------" ,"---------", "------", "-------", "------"], 
                ["15:15 - 16:00 ", "CANUM", "------" ,"---------", "------", "-------", "------"], 
                ["16:00 - 16:45 ", "CANUM", "------" ,"---------", "------", "-------", "------"], 
    ...
    HorarioC = [["Entrada/Salida", "LUNES", "MARTES", "MIERCOLES", "JUEVES", "VIERNES", "SABADO"], 
                ["7:00 - 7:45   ", "-----", "CILOGG" ,"---------", "------", "CILOGG ", "------"], 
                ["7:45 - 8:30   ", "-----", "CILOGG" ,"---------", "------", "CILOGG ", "LENPR2"], 
                ["8:30 - 9:15   ", "-----", "CILOGG" ,"---------", "------", "CILOGG ", "LENPR2"], 
                ["9:15 - 10:00  ", "ANDSS", "CILOGG" ,"---------", "TGGRAF", "-------", "------"], 
                ["10:00 - 10:45 ", "ANDSS", "------" ,"---------", "TGGRAF", "-------", "------"], 
                ["10:45 - 11:30 ", "ANDSS", "------" ,"---------", "TGGRAF", "-------", "------"], 
                ["11:30 - 12:15 ", "ANDSS", "------" ,"---------", "TGGRAF", "BASDA  ", "------"], 
                ["13:00 - 13:45 ", "-----", "------" ,"---------", "------", "BASDA  ", "------"], 
                ["13:45 - 14:30 ", "BASDA", "------" ,"INVESOPER", "LENPR2", "-------", "------"], 
                ["14:30 - 15:15 ", "BASDA", "------" ,"INVESOPER", "LENPR2", "-------", "------"], 
                ["15:15 - 16:00 ", "BASDA", "------" ,"INVESOPER", "LENPR2", "-------", "------"], 
                ["16:00 - 16:45 ", "BASDA", "------" ,"INVESOPER", "LENPR2", "-------", "------"], 
                ["16:45 - 17:30 ", "-----", "------" ,"---------", "------", "-------", "------"]]
    ...
    HorarioC = [["Entrada/Salida", "LUNES", "MARTES", "MIERCOLES", "JUEVES", "VIERNES", "SABADO"], 
                ["7:00 - 7:45   ", "-----", "------" ,"OPTLIN   ", "------", "-------", "ARCOM "], 
                ["7:45 - 8:30   ", "-----", "------" ,"OPTLIN   ", "------", "-------", "ARCOM "], 
                ["8:30 - 9:15   ", "-----", "------" ,"OPTLIN   ", "------", "DÑDSST ", "ARCOM "], 
                ["9:15 - 10:00  ", "-----", "------" ,"OPTLIN   ", "------", "DÑDSST ", "------"], 
                ["10:00 - 10:45 ", "-----", "------" ,"---------", "------", "DÑDSST ", "------"], 
                ["10:45 - 11:30 ", "ARCOM", "------" ,"---------", "OPTLIN", "-------", "------"], 
                ["11:30 - 12:15 ", "ARCOM", "------" ,"---------", "OPTLIN", "-------", "SSOPTI"], 
                ["13:00 - 13:45 ", "ARCOM", "------" ,"---------", "OPTLIN", "-------", "SSOPTI"], 
                ["13:45 - 14:30 ", "ARCOM", "------" ,"---------", "OPTLIN", "-------", "SSOPTI"], 
                ["14:30 - 15:15 ", "-----", "------" ,"LENPROOG3", "------", "PROESTS", "------"], 
                ["15:15 - 16:00 ", "-----", "DÑDSST" ,"LENPROOG3", "------", "PROESTS", "------"], 
                ["16:00 - 16:45 ", "-----", "DÑDSST" ,"LENPROOG3", "------", "PROESTS", "------"], 
                ["16:45 - 17:30 ", "-----", "DÑDSST" ,"LENPROOG3", "------", "PROESTS", "------"]]
    ...
    print(f"Lenguaje de Programación III: {HorarioC[10][3]} - Profesora Lucía Santeramo")
    ...
    HorarioC = [["Entrada/Salida", "LUNES", "MARTES", "MIERCOLES", "JUEVES", "VIERNES", "SABADO"], 
                ["7:00 - 7:45   ", "GRDIN", "METDIN" ,"---------", "------", "METDIN ", "------"], 
                ["7:45 - 8:30   ", "GRDIN", "METDIN" ,"---------", "ELTEC1", "METDIN ", "------"], 
                ["8:30 - 9:15   ", "GRDIN", "METDIN" ,"---------", "ELTEC1", "METDIN ", "------"], 
                ["9:15 - 10:00  ", "INTSS", "------" ,"---------", "------", "-------", "------"], 
                ["10:00 - 10:45 ", "INTSS", "RETDDS" ,"---------", "------", "-------", "GRDIN "], 
                ["10:45 - 11:30 ", "INTSS", "RETDDS" ,"---------", "ELNTE2", "-------", "GRDIN "], 
                ["11:30 - 12:15 ", "-----", "RETDDS" ,"---------", "ELNTE2", "-------", "GRDIN "], 
                ["13:00 - 13:45 ", "-----", "------" ,"SINMMULCI", "------", "-------", "------"], 
                ["13:45 - 14:30 ", "-----", "------" ,"SINMMULCI", "------", "-------", "------"], 
                ["14:30 - 15:15 ", "-----", "------" ,"SINMMULCI", "------", "-------", "------"], 
                ["15:15 - 16:00 ", "-----", "------" ,"SINMMULCI", "------", "-------", "------"], 
                ["16:00 - 16:45 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["16:45 - 17:30 ", "-----", "------" ,"---------", "------", "-------", "------"]]
    ...
    HorarioC = [["Entrada/Salida", "LUNES", "MARTES", "MIERCOLES", "JUEVES", "VIERNES", "SABADO"], 
                ["7:00 - 7:45   ", "-----", "------" ,"TLECPROSC", "------", "TEODDC ", "------"], 
                ["7:45 - 8:30   ", "-----", "------" ,"TLECPROSC", "------", "TEODDC ", "MALEI "], 
                ["8:30 - 9:15   ", "-----", "------" ,"TLECPROSC", "------", "TEODDC ", "MALEI "], 
                ["9:15 - 10:00  ", "AUDSS", "------" ,"TLECPROSC", "------", "TEODDC ", "MALEI "], 
                ["10:00 - 10:45 ", "AUDSS", "------" ,"---------", "------", "-------", "------"], 
                ["10:45 - 11:30 ", "AUDSS", "------" ,"---------", "------", "-------", "------"], 
                ["11:30 - 12:15 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["13:00 - 13:45 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["13:45 - 14:30 ", "MALEI", "AUDSS " ,"---------", "------", "-------", "------"], 
                ["14:30 - 15:15 ", "MALEI", "AUDSS " ,"---------", "TEODDC", "ELNTEC2", "ELTEC2"], 
                ["15:15 - 16:00 ", "MALEI", "AUDSS " ,"---------", "TEODDC", "ELNTEC2", "ELTEC2"], 
                ["16:00 - 16:45 ", "-----", "------" ,"---------", "TEODDC", "ELNTEC2", "ELTEC2"], 
                ["16:45 - 17:30 ", "-----", "------" ,"---------", "TEODDC", "-------", "------"]]

    print(f"Auditoría de Sistemas: {HorarioC[4][1]} - Profesor Oliver Mundaray")
    print(f"Marco Legal para el Ejercicio de la Ingeniería: {HorarioC[9][1]} - Profesor Melvin Contrera")
    ...
    print("\nPasante: Master One\n")
    HorarioC = [["Entrada/Salida", "LUNES", "MARTES", "MIERCOLES", "JUEVES", "VIERNES", "SABADO"], 
                ["7:00 - 7:45   ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["7:45 - 8:30   ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["8:30 - 9:15   ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["9:15 - 10:00  ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["10:00 - 10:45 ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["10:45 - 11:30 ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["11:30 - 12:15 ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["13:00 - 13:45 ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["13:45 - 14:30 ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["14:30 - 15:15 ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["15:15 - 16:00 ", "PASST", "PASST " ,"PASST    ", "PASST ", "PASST  ", "PASST "], 
                ["16:00 - 16:45 ", "-----", "------" ,"---------", "------", "-------", "------"], 
                ["16:45 - 17:30 ", "-----", "------" ,"---------", "------", "-------", "------"]]

    print(f"Pasantias: {HorarioC[1][4]} - Ingeniero de Sistemas Supervisor Kelvin Centeno\n")
